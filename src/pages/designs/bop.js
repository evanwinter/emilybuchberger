  ...
  return (
    <Fragment>
      ...
      <ProjectLayout name="bop">
        ...
        <ProjectRow
          style={{ margin: `0rem auto 5rem auto` }}
        ...
        <ProjectRow
          style={{ margin: `5rem auto 5rem auto` }}
          ...
          <Columns>
            ...
            <div className="copy">
              <div className="content-wrapper">
                ...
                <p>
                  When you hear a song you like it takes multiple steps to find
                  out what it is and then add it to your library.
                </p>
                <h3>Solutions:</h3>
                <p>
